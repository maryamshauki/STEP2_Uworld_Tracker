# UWorld Step 2 QBank Tracker

Made by [Maryam Shaukat](https://github.com/maryamshauki)

A lightweight, no frills tracker for your UWorld Step 2 QBank progress. Log blocks as you attempt and review them, watch your pace toward a daily/overall goal, and keep a simple to do list of reminders you can check off.
...
Built in to do list: jot reminders and mark them done as you go.
...
Have ideas or found a bug? Open a [Discussion](../../discussions) or an [Issue](../../issues). Would love to hear from you.
